        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            resetCSS = function () {
                ...
                $('.b-page').css({
                    ...
                    width:   options.pWidth-(2*options.pagePadding),
                    height:  options.pHeight-(2*options.pagePadding)
                });
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            goToPage = function (newIndex) {
                ...
                if(newIndex > options.currentIndex && newIndex < options.pageTotal && newIndex >= 0 && !isBusy) {
                    ...
                    p2.transition({rotateY: '-90deg'}, options.speed/2, 'in', function(){
                        p2.css({zIndex:20})
                          .transition({rotateY: '-180deg'}, options.speed/2, 'out');
                    });

                    p3.transition({rotateY: '90deg'}, options.speed/2, 'in', function(){
                        p3.css({zIndex:30})
                          .transition({rotateY: '0deg'}, options.speed/2, 'out', function(){updateAfter()});
                    });
                    ...
                    pN.transition({rotateY: '0deg'}, options.speed/2);
                    p0.transition({rotateY: '0deg'}, options.speed, 'in-out');
                    p1.transition({rotateY: '181deg'}, options.speed, 'in-out', function(){updateAfter()});
